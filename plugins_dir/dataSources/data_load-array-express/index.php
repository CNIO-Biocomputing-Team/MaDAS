<?php 
	...
	$plugin_path = 'plugins_dir/dataSources/data_load-array-express/';
...
<div class="header1"><b>Load Genes</b></div>
<div class="pluginBox" style="height:340px;">
	<div id="step0" />
	<div id="step1">
		<form id="das_load-gffForm" action="<?=$plugin_path?>d_index.php" method="post" enctype="multipart/form-data">
			...
			<input type="hidden" id="solmetraUploaderData_file1" name="solmetraUploaderData[file1]" value="geneFile" /> <!-- set value to form field name -->
			...
			<table align="left">
				<tbody>
	              ...
	              <tr>
	                   <td class="option">3) Upload your .csv file *</td>
