...
<div id="f-segments-edit-box">
    ...
    <form name="f-segment-edit" method="post" id="f-segment-edit" action="<?=$plugin_path?>v_feature_edit_r.php">
        ...
        <table class="result" cellspaccing="0">
            <tr><td class="option">ID/Label *</td><td class="value"><input class="required" type="text" id="t_value_id" name="t_value_id" value="<?=$id?>" size="50" /></td></tr>
             <tr>
			...
			<tr><td class="option">Start *</td><td class="value"><input class="required" type="text" name="t_value_start" value="<?=$start?>" size="20" /></td></tr>
			<tr><td class="option">End *</td><td class="value"><input class="required" type="text" name="t_value_stop" value="<?=$end?>" size="20" /></td></tr>
