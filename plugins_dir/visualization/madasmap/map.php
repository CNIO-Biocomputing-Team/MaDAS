<?
	...
	$size 			= @$_REQUEST['size'];
	$das_server		= (@$_REQUEST['das_servers'] != 'undefined')?@$_REQUEST['das_servers']:'http://madas2.bioinfo.cnio.es/plugins_dir/dasServers/das_common-server/das.php/';
...
<div id="madasmap1">
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="DasSequenceWidget" width="850" height="600" codebase="http://fpdownload.macromedia.com/get/flashplayer/current/swflash.cab">
		<param name="movie" value="http://contexts.bioinfo.cnio.es/flash/DasSequenceWidget.swf" />
		<param name="quality" value="high" />
		<param name="bgcolor" value="#FFFFFF" />
		<param name="allowScriptAccess" value="sameDomain" />
                <param name="flashVars" value="  flashVars="reference=<?=$das_server?><?=$current_dsn?>&annotationsource=<?=$das_server?><?=$current_dsn?>&entrypoint=<?=$segment?>&entrypointsize=<?=$size?>&pid=<?=$pid ?>" />
		<embed src="http://contexts.bioinfo.cnio.es/flash/DasSequenceWidget.swf" quality="high" bgcolor="#FFFFFF" width="850" height="600" name="DasSequenceWidget" align="middle"	play="true"	loop="false" quality="high"	allowScriptAccess="sameDomain"	type="application/x-shockwave-flash"  flashVars="reference=<?=$das_server?><?=$current_dsn?>&annotationsource=<?=$das_server?><?=$current_dsn?>&entrypoint=<?=$segment?>&entrypointsize=<?=$size?>&pid=<?=$pid ?>"	pluginspage="http://www.adobe.com/go/getflashplayer">
		</embed>
</object>
</div>
