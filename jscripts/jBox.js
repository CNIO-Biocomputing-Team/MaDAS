...
*/
var jBox={
    imgs:['min.gif', 'bclose.gif', 'restore.gif','resize.gif'],
	...
	init:function(id){
		...
		var box = $('<div class="jBox" id="jb'+id+'"></div' ).appendTo(holder);
			box.append('<div class="jBoxHandler">jBox<div class="jBoxControls"><img src="'+this.imgs[0]+'" title="Minimize" /><img src="images/'+this.imgs[1]+'" title="Close" alt="Close"/></div></div>')
